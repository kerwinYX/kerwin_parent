...
import com.kerwin.educenter.utils.ConstantWxUtils;
import com.kerwin.educenter.utils.HttpClientUtils;
...
public class WxApiController {
    ...
    //2 获取扫描人信息，添加数据  实际项目中 不需要此方法  因为代码是直接发布到了云服务器上的
    // 因为扫描二维码之后会自动调用callback方法
    @GetMapping("callback")
    public String callback(String code, String state) {
        try {
            ...
            throw new KerwinException(20001,"登录失败");
        }
    }
